...
class LowShelfBand(FilterBand):
    """
    Low Shelf Band Class for creating a low shelf filter for an EQ.
    """
    def __init__(self, centerFreq, dBgain, q, fs):
        """
        Constructor for the LowShelfBand class.
        ...
        """
        super().__init__("Low Shelf", centerFreq, q, dBgain, fs)
