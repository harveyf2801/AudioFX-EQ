...
class HighCutBand(FilterBand):
    """
    High Cut Band Class for creating a high cut filter for an EQ.
    """
    def __init__(self, centerFreq, q, fs):
        """
        Constructor for the HighCutBand class.
        ...
        """
        super().__init__("High Cut", centerFreq, q, 0, fs)  # Default setting the dBgain to 0
