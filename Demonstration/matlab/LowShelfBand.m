%% Low Shelf Band Class
% This function creates a low shelf filter for an EQ.
%
...
classdef LowShelfBand < FilterBand

    methods
        function obj = LowShelfBand(centerFreq, dBgain, q, fs)
            %%LOW SHELF BAND Constructor for the LowShelfBand class.

            obj@FilterBand("Low Shelf", centerFreq, q, dBgain, fs);
        end

        function [b, a] = calculateCoefficients(obj)
            %%CALCULATE COEFFICIENTS Outputs IIR coeffs b and a for a standard low shelf filter band.
